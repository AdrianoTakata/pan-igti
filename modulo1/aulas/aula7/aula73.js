...
// 3. map --> retorna um array

let names = usPresidents.map((item) => {
  return item.president
})

console.log(names)

// 4. filter --> retorna um array

let partido = usPresidents.filter((item) => {
...
// 5. find --> encontra o primeiro elemento do array

let p1 = usPresidents.find((item) => {
  return item.party == "Democratic"
})
